        ...
        <div class="swiper-slide">
          <div class="overflow-hidden position-relative h-100">
            <div class="slideshow-character position-absolute bottom-0 pos_right-center">
              <img loading="lazy" src="{{ asset('uploads/Slider') }}/{{ $slider->image }}" width="542" height="733"
                alt="Woman Fashion 1"
            ...
            <div class="slideshow-text container position-absolute start-50 top-50 translate-middle">
              ...
              <h2 class="h1 fw-bold animate animate_fade animate_btt animate_delay-5">{{ $slider->category }}</h2>
              <a href="{{ $slider->link }}"
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-lg-8 col-xl-80per">
                  ...
                  <div class="swiper-slide product-card product-card_style3">
                    <div class="pc__img-wrapper">
                      <a href="{{ route('shop.product.detail', ['product_slug' => $sproduct->slug]) }}">
                        <img loading="lazy" src="{{ $sproduct->image ? asset('uploads/products').'/'.$sproduct->image : asset('assets/images/no-image.png') }}" width="258" height="313"
                          alt="{{ $sproduct->name }}" class="pc__img">
                        @if($sproduct->images)
                        <img loading="lazy" src="{{ asset('uploads/products') }}/{{ $sproduct->images }}" width="258" height="313"
            ...
            <div class="product-card__price d-flex">
              ...
              @if(is_numeric($sproduct->sale_price) && $sproduct->sale_price > 0)
                {{ $sproduct->sale_price }}
              @elseif(is_numeric($sproduct->regular_price) && $sproduct->regular_price > 0)
              ...
              @endif
                      ...
                      <div
                        ...
                        <form method="POST" action="{{ route('cart.add') }}" class="d-inline">
                          ...
                          <input type="hidden" name="price" value="{{ (is_numeric($sproduct->sale_price) && $sproduct->sale_price > 0) ? (string)$sproduct->sale_price : ((is_numeric($sproduct->regular_price) && $sproduct->regular_price > 0) ? (string)$sproduct->regular_price : '0') }}">
                          <button type="submit" class="btn-link btn-link_lg me-4 text-uppercase fw-medium" title="Add To Cart">Add To Cart</button>
                        </form>
         ...
         @foreach ($sproducts as $sproduct)
          <div class="col-6 col-md-4 col-lg-3">
            <div class="product-card product-card_style3 mb-3 mb-md-4 mb-xxl-5">
              <div class="pc__img-wrapper">
                <a href="{{ route('shop.product.detail', ['product_slug' => $sproduct->slug]) }}">
                  <img loading="lazy" src="{{ $sproduct->image ? asset('uploads/products').'/'.$sproduct->image : asset('assets/images/no-image.png') }}" width="330" height="400"
                    alt="{{ $sproduct->name }}" class="pc__img">
                  @if($sproduct->images)
                  <img loading="lazy" src="{{ asset('uploads/products') }}/{{ $sproduct->images }}" width="330" height="400"
                    alt="{{ $sproduct->name }}" class="pc__img pc__img-second">
                  @endif
                </a>
