            ...
            <div class="flex items-center justify-between gap10 flex-wrap">
                <div class="wg-filter flex-grow">
                    <form class="form-search" method="GET" action="{{ route('admin.products') }}">
                        <fieldset class="name">
                            <input type="text" placeholder="Search products..." class="" name="name"
                ...
                <table class="table table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $product->regular_price ? '$' . number_format($product->regular_price, 2) : '-' }}</td>
                            ...
                            <td>
                                <div class="list-icon-function">
                                   ...
                                   <form action="{{ route('admin.products.delete', $product->id) }}" method="POST" style="display:inline;">
                                       @csrf
                                       @method('DELETE')
                                       <button type="submit" class="item text-danger delete" onclick="return confirm('Are you sure you want to delete this product?')">
