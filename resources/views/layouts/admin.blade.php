                ...
                <div class="section-content-right">
                    ...
                    <div class="header-dashboard">
                        <div class="wrap">
                            <div class="header-left">
                                ...
                                <form class="form-search flex-grow" method="GET" action="{{ route('admin.products') }}">
                                    <fieldset class="name">
                                        <input type="text" placeholder="Search products..." class="show-search" name="name"
                                    ...
                                    <div class="dropdown">
                                        <button class="btn btn-secondary dropdown-toggle" type="button"
                                            ...
                                            <span class="header-item">
                                                <span class="text-tiny">{{ isset($notifications) ? $notifications->count() : 0 }}</span>
                                                <i class="icon-bell"></i>
                                            </span>
                                        </button>
                                                ...
                                                @foreach($notifications as $notification)
                                                    <li>
                                                        <div class="message-item">
                                                            ...
                                                            <div>
                                                                <div class="body-title-2">{{ $notification->data['title'] ?? 'Notification' }}</div>
                                                                <div class="text-tiny">{{ $notification->data['body'] ?? '' }}</div>
                                                                <div class="text-tiny text-muted">{{ $notification->created_at->diffForHumans() }}</div>
                                                            </div>
                                                        </div>
                                                    </li>
                                                @endforeach
                                            @else
                                                <li><div class="text-tiny text-center">No new notifications</div></li>
                                            @endif
                    ...
                    <div class="main-content">
                        ...
                        <div class="bottom-page">
                            <div class="body-text">Copyright © 2025 bura</div>
                        </div>
                    </div>
